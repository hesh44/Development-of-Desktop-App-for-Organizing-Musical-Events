...
namespace MuzickiDogadjaj
{
    class KBrisanjeIzmenaIzvodjaca
    {
        ...
        internal bool ObrisiGlumca(ComboBox cmbIzvodjac)
        {
            try
            {
        ...
        internal bool IzmeniGlumca(ComboBox cmbIzvodjac, TextBox txtImePrezime, TextBox txtUmetnickoIme, TextBox txtZanr)
        {
            try
            {
                if (cmbIzvodjac.SelectedIndex < 0)
