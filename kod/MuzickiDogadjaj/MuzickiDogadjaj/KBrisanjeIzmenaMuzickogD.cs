...
namespace MuzickiDogadjaj
{
    public class KBrisanjeIzmenaMuzickogD
    {
        ...
        internal bool ObrisiMuzickiD(ComboBox cmbMuzickiD)
        {
            try
            {
        ...
        internal bool SacuvajIzmenuMuzickogD(ComboBox cmbMuzickiD, TextBox txtNazivDogadjaja, TextBox txtKapacitet, ComboBox cmbLokacija)
        {
            try
            {
                if (cmbMuzickiD.SelectedIndex < 0)
